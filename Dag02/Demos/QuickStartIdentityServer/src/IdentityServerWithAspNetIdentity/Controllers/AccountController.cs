        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    /////////////////////////////////////////
                    await _userManager.AddClaimAsync(user, new Claim(ClaimTypes.Email, user.Email, ClaimValueTypes.Email));
                    await _userManager.AddClaimAsync(user, new Claim(ClaimTypes.DateOfBirth, "01/01/2001", ClaimValueTypes.Date));
                    /////////////////////////////////////////
